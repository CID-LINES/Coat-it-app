        ...
        case _reactNativeGestureHandler.State.END:
          {
            ...
            if (gestureDirection === 'horizontal-inverted' || gestureDirection === 'vertical-inverted') {
              translation *= -1;
              velocity *= -1;
            }

            const closing = translation + velocity * gestureVelocityImpact > distance / 2 ? velocity !== 0 || translation !== 0 : false;
            this.animate({
              closing,
              velocity
            });
