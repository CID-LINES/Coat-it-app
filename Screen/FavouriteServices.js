...
export default class FavouriteServices extends Component {
    ...
    FavouriteServicesApi = () => {
        this.setState({
            isLoading: true
        })
        fetch('http://18.156.66.145/public/api/favourite_serviceList/' + '' + this.state.user_id,
            {
                method: 'GET',
                headers: {
            ...
            .then((responseJson) => {
                ...
                if (responseJson.response.status == true) {
                    this.setState({
                        DATA: responseJson.response.services_list,
                    })
                }
                else {
    ...
    onRefresh = () => {
        this.setState({ isFetching: true }, function () { this.FavouriteServicesApi() });
    }
